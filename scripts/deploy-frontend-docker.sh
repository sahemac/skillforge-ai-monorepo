...
# Script pour déployer les applications frontend avec Docker local
# Usage: ./deploy-frontend-docker.sh <app-name>
...
# Copier les packages nécessaires pour le build
cp -r ../../../packages ./packages || true
