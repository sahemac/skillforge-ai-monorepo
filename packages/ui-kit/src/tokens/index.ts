/**
 * Design tokens for SkillForge AI Design System
 * Provides consistent values for colors, spacing, typography, motion, and more
 */
...
// Export all tokens as a combined object
export const tokens = {
  colors,
  spacing,
  typography,
