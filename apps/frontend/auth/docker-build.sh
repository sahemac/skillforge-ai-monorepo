...
# Script de build Docker pour SkillForge AI Auth App
...
build_image() {
    ...
    # Build de l'image
    docker build \
        -f "apps/frontend/auth/$DOCKERFILE" \
        -t "$image_name" \
...
# Fonction principale
main() {
    log_info "Starting Docker build for SkillForge AI Auth App"
