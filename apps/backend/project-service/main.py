"""
SkillForge AI - Project-service
FastAPI application entry point for Project management and collaboration
"""
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting SkillForge AI Project-service...")
    ...
    # Shutdown
    logger.info("Shutting down SkillForge AI Project-service...")
...
# Create FastAPI app
app = FastAPI(
    title="SkillForge AI - Project-service",
...
app.add_middleware(
    ...
    backend_service_id="project-service-backend-staging"
)
...
async def root():
    ...
    return {
        "service": "skillforge-ai-project-service",
        "version": "1.0.0",
        "status": "healthy",
