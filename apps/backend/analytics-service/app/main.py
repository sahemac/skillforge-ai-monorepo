"""
SkillForge AI - Analytics Service
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting SkillForge AI Analytics Service...")
    
    yield
    
    # Shutdown
    logger.info("Shutting down SkillForge AI Analytics Service...")


# Create FastAPI app
app = FastAPI(
    title="SkillForge AI - Analytics Service",
...
async def root():
    ...
    return {
        "service": "skillforge-ai-analytics_service-service",
        "version": "1.0.0",
        "status": "healthy",
