"""
Configuration settings for SkillForge AI Subscription Service
"""
...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "SkillForge AI Subscription Service"
    ...
    POSTGRES_DB: str = Field(default="skillforge_subscription", env="POSTGRES_DB")
    ...
    # External Services
    PAYMENT_SERVICE_URL: Optional[str] = Field(default="http://payment-service:8000", env="PAYMENT_SERVICE_URL")
