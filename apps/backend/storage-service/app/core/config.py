"""
Configuration settings for SkillForge AI Storage Service
"""
...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "SkillForge AI Storage Service"
    ...
    POSTGRES_DB: str = Field(default="skillforge_storage", env="POSTGRES_DB")
