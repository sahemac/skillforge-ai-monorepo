"""
Configuration settings for SkillForge AI Notification Service
"""
...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "SkillForge AI Notification Service"
    ...
    POSTGRES_DB: str = Field(default="skillforge_notification", env="POSTGRES_DB")
