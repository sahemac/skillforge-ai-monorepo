...
FastAPI application entry point for Algorithm for matching users, jobs, and skills
"""
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting SkillForge AI Matching-service...")
    ...
    # Shutdown
    logger.info("Shutting down SkillForge AI Matching-service...")
...
# Create FastAPI app
app = FastAPI(
    title="SkillForge AI - Matching-service",
    description="Algorithm for matching users, jobs, and skills",
    version="1.0.0",
...
app.add_middleware(
    ...
    backend_service_id="matching-service-backend-staging"
)
...
async def root():
    ...
    return {
        "service": "skillforge-ai-matching-service",
        "version": "1.0.0",
        "status": "healthy",
