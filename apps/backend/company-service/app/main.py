...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting SkillForge AI Company Service...")
    ...
    # Shutdown
    logger.info("Shutting down SkillForge AI Company Service...")


# Create FastAPI app
app = FastAPI(
    title="SkillForge AI - Company Service",
...
async def add_process_time_header(request: Request, call_next):
    ...
    response.headers["X-Service-Name"] = "company-service"
...
async def root():
    ...
    return {
        "service": "skillforge-ai-company-service",
        "version": "1.0.0",
        "status": "healthy",
