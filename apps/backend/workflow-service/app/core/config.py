"""
Configuration settings for SkillForge AI Workflow Service
"""
...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "SkillForge AI Workflow Service"
    ...
    POSTGRES_DB: str = Field(default="skillforge_workflow", env="POSTGRES_DB")
    ...
    WORKFLOW_ENGINE: Optional[str] = Field(default=None, env="WORKFLOW_ENGINE")\n    CELERY_BROKER_URL: Optional[str] = Field(default=None, env="CELERY_BROKER_URL")\n    
    # Monitoring
