"""
Configuration settings for SkillForge AI Search Service
"""
...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "SkillForge AI Search Service"
    ...
    POSTGRES_DB: str = Field(default="skillforge_search", env="POSTGRES_DB")
