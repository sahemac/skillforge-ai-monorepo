"""
SkillForge AI - Gamification-service
FastAPI application entry point for Badges, points, achievements, and leaderboards
"""
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting SkillForge AI Gamification-service...")
    ...
    # Shutdown
    logger.info("Shutting down SkillForge AI Gamification-service...")
...
# Create FastAPI app
app = FastAPI(
    title="SkillForge AI - Gamification-service",
    description="Badges, points, achievements, and leaderboards",
    version="1.0.0",
...
app.add_middleware(
    ...
    backend_service_id="gamification-service-backend-staging"
)
...
async def root():
    ...
    return {
        "service": "skillforge-ai-gamification-service",
        "version": "1.0.0",
        "status": "healthy",
