"""
Configuration settings for SkillForge AI Content Service
"""
...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "SkillForge AI Content Service"
    ...
    POSTGRES_DB: str = Field(default="skillforge_content", env="POSTGRES_DB")
