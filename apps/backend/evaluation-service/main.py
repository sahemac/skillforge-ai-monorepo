"""
SkillForge AI - Evaluation-service
FastAPI application entry point for 360° evaluation system for skills and performance
"""
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting SkillForge AI Evaluation-service...")
    ...
    # Shutdown
    logger.info("Shutting down SkillForge AI Evaluation-service...")
...
# Create FastAPI app
app = FastAPI(
    title="SkillForge AI - Evaluation-service",
    description="360° evaluation system for skills and performance",
    version="1.0.0",
...
app.add_middleware(
    ...
    backend_service_id="evaluation-service-backend-staging"
)
...
async def root():
    ...
    return {
        "service": "skillforge-ai-evaluation-service",
        "version": "1.0.0",
        "status": "healthy",
