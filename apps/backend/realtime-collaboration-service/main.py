"""
SkillForge AI - Realtime-collaboration-service
FastAPI application entry point for Pair programming and live coding
"""
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting SkillForge AI Realtime-collaboration-service...")
    ...
    logger.info("Realtime-collaboration-service initialized")
    
    yield
    
    # Shutdown
    logger.info("Shutting down SkillForge AI Realtime-collaboration-service...")
...
# Create FastAPI app
app = FastAPI(
    title="SkillForge AI - Realtime-collaboration-service",
    description="Pair programming and live coding",
    version="1.0.0",
...
app.add_middleware(
    ...
    backend_service_id="realtime-collaboration-service-backend-staging"
)
...
async def root():
    ...
    return {
        "service": "skillforge-ai-realtime-collaboration-service",
        "version": "1.0.0",
        "status": "healthy",
...
async def health_check():
    ...
    return {
        "status": status,
        "timestamp": time.time(),
        "service": "realtime-collaboration-service",
        "version": "1.0.0",
        "checks": {
