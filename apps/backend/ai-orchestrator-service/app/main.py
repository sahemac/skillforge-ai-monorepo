...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting SkillForge AI Ai Orchestrator Service...")
    ...
    # Shutdown
    logger.info("Shutting down SkillForge AI Ai Orchestrator Service...")
...
async def root():
    ...
    return {
        ...
        "description": "Microservice for AI agent coordination and orchestration"
    }
