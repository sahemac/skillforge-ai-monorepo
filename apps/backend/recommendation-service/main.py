"""
SkillForge AI - Recommendation-service
FastAPI application entry point for Recommendation engine for learning paths and content
"""
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting SkillForge AI Recommendation-service...")
    ...
    # Shutdown
    logger.info("Shutting down SkillForge AI Recommendation-service...")
...
# Create FastAPI app
app = FastAPI(
    title="SkillForge AI - Recommendation-service",
    description="Recommendation engine for learning paths and content",
    version="1.0.0",
...
app.add_middleware(
    ...
    backend_service_id="recommendation-service-backend-staging"
)
...
async def root():
    ...
    return {
        "service": "skillforge-ai-recommendation-service",
        "version": "1.0.0",
        "status": "healthy",
